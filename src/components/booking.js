    ...
    <Base>
      <div className="booking-div">
        <div className="container-fluid d-flex justify-content-center align-items-center align-content-center">
          <div>
            {bookedBike.length == 0 ? (
              <h5 className="text-dark text-uppercase fw-bold">No Bookings</h5>
            ) : (
              <h5 className="text-dark text-uppercase fw-bold">
                Your bookings
              </h5>
            )}
            <div className="booked-bikes mt-4 d-flex justify-content-center align-items-center flex-row flex-wrap">
              {bookedBike.map((bike) => (
                <div className="bike-data">
                  ...
                  <p>
                    <small>From :{bike.startDate.slice(0, 16)}</small>
                  </p>
                  <p>
                    <small>To :{bike.endDate.slice(0, 16)}</small>
                  </p>
                </div>
              ))}
            </div>
